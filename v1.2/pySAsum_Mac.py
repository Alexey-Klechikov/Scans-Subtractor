...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def diff_line(self):
        ...
        if not self.comboBox_point_number_A.currentText() == "" and not self.comboBox_polarisation_A.currentText() == "":
            self.line_A = "A(" + str(self.comboBox_polarisation_A.currentText()) + ")(" + str(
        ...
        if not self.comboBox_point_number_B.currentText() == "" and not self.comboBox_polarisation_B.currentText() == "":
            self.line_B = "B(" + str(self.comboBox_polarisation_B.currentText()) + ")(" + str(
                self.comboBox_point_number_B.currentText()) + ")"

        # fill one of the scans if only one is imported
        if not self.line_A == "" and self.line_B == "":
            line = self.line_A
        elif self.line_A == "" and not self.line_B == "":
            line = self.line_B
    ...
    def draw_res(self):
        ...
        # Do the subtraction
        if self.line_A == "" and not self.line_B == "":
            res = self.detector_image_B
        elif not self.line_A == "" and self.line_B == "":
