# pyinstaller --onefile --noconsole -i"C:\icon.ico" --add-data C:\icon.ico;images C:\pySAsum_V1.4.py

from PyQt5 import QtCore, QtGui, QtWidgets
import pyqtgraph as pg
import numpy, h5py, os, sys, pkgutil
...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        font_headline.setPointSize(11) # Mac 13
        font_headline.setBold(True)

        font_graphs = QtGui.QFont()
        font_graphs.setPixelSize(12) # Mac 12
        font_graphs.setBold(False)

        font_ee = QtGui.QFont()
        font_ee.setPointSize(9) # Mac 11
        ...
        # Main window
        MainWindow_size = [1100, 809] # Mac 1100, 787
        ...
        self.__create_element(self.groupBox_scan_A, [5, 20, 300, 361], "groupBox_scan_A")
        self.lineEdit_scan_A_name = QtWidgets.QLineEdit(self.groupBox_scan_A)
        self.__create_element(self.lineEdit_scan_A_name, [5, 8, 260, 20], "lineEdit_scan_A_name", font=font_ee)
        self.toolButton_scan_A = QtWidgets.QToolButton(self.groupBox_scan_A)
        self.__create_element(self.toolButton_scan_A, [275, 8, 20, 20], "toolButton_scan_A", text="...", font=font_ee)
        self.label_scan_A_type = QtWidgets.QLabel(self.groupBox_scan_A)
        self.__create_element(self.label_scan_A_type, [5, 31, 40, 20], "label_scan_A_type", text="Type:", font=font_ee)
        self.comboBox_scan_A_type = QtWidgets.QComboBox(self.groupBox_scan_A)
        self.__create_element(self.comboBox_scan_A_type, [45, 31, 150, 20], "comboBox_scan_A_type", combo=["Single point", "Integrated image", "2D map"], font=font_ee)
        self.graphicsView_scan_A = pg.ImageView(self.groupBox_scan_A)
        self.__create_element(self.graphicsView_scan_A, [3, 56, 295, 275], "graphicsView_scan_A")
        ...
        self.__create_element(self.label_scan_A_polarisation, [5, 336, 75, 20], "label_scan_A_polarisation", text="Polarisation:", font=font_ee)
        self.comboBox_scan_A_polarisation = QtWidgets.QComboBox(self.groupBox_scan_A)
        self.__create_element(self.comboBox_scan_A_polarisation, [75, 336, 55, 20], "comboBox_scan_A_polarisation", font=font_ee)
        self.label_scan_A_point_number = QtWidgets.QLabel(self.groupBox_scan_A)
        self.__create_element(self.label_scan_A_point_number, [158, 336, 80, 20], "label_scan_A_point_number", text="Point number:", font=font_ee)
        self.comboBox_scan_A_point_number = QtWidgets.QComboBox(self.groupBox_scan_A)
        self.__create_element(self.comboBox_scan_A_point_number, [240, 336, 55, 20], "comboBox_scan_A_point_number", font=font_ee)
        ...
        self.__create_element(self.groupBox_scan_B, [5, 405, 300, 361], "groupBox_scan_B")
        self.lineEdit_scan_B_name = QtWidgets.QLineEdit(self.groupBox_scan_B)
        self.__create_element(self.lineEdit_scan_B_name, [5, 8, 260, 20], "lineEdit_scan_B_name", font=font_ee)
        self.toolButton_scan_B = QtWidgets.QToolButton(self.groupBox_scan_B)
        self.__create_element(self.toolButton_scan_B, [275, 8, 20, 20], "toolButton_scan_B", text="...", font=font_ee)
        self.label_scan_B_type = QtWidgets.QLabel(self.groupBox_scan_B)
        self.__create_element(self.label_scan_B_type, [5, 31, 40, 20], "label_scan_B_type", text="Type:", font=font_ee)
        self.comboBox_scan_B_type = QtWidgets.QComboBox(self.groupBox_scan_B)
        self.__create_element(self.comboBox_scan_B_type, [45, 31, 150, 20], "comboBox_scan_B_type", combo=["Single point", "Integrated image", "2D map"], font=font_ee)
        self.graphicsView_scan_B = pg.ImageView(self.groupBox_scan_B)
        self.__create_element(self.graphicsView_scan_B, [3, 56, 295, 275], "graphicsView_scan_B")
        ...
        self.__create_element(self.label_scan_B_polarisation, [5, 336, 75, 20], "label_scan_B_polarisation", text="Polarisation:", font=font_ee)
        self.comboBox_scan_B_polarisation = QtWidgets.QComboBox(self.groupBox_scan_B)
        self.__create_element(self.comboBox_scan_B_polarisation, [75, 336, 55, 20], "comboBox_scan_B_polarisation", font=font_ee)
        self.label_scan_B_point_number = QtWidgets.QLabel(self.groupBox_scan_B)
        self.__create_element(self.label_scan_B_point_number, [158, 336, 80, 20], "label_scan_B_point_number", text="Point number:", font=font_ee)
        self.comboBox_scan_B_point_number = QtWidgets.QComboBox(self.groupBox_scan_B)
        self.__create_element(self.comboBox_scan_B_point_number, [240, 336, 55, 20], "comboBox_scan_B_point_number", font=font_ee)
        ...
        self.__create_element(self.groupBox_result, [320, 20, 775, 746], "groupBox_result")
        # ROI part is hidden by default
        self.graphicsView_result_integrated_roi = pg.PlotWidget(self.groupBox_result)
        self.__create_element(self.graphicsView_result_integrated_roi, [3, 430, 770, 265], "graphicsView_result_integrated_roi")
        ...
        self.__create_element(self.label_result_roi_coorddinates, [10, 696, 400, 22], "label_result_roi_coorddinates", text="ROI coordinates: left                 right                 top                   bottom", font=font_ee)
        self.lineEdit_result_roi_left = QtWidgets.QLineEdit(self.groupBox_result)
        self.__create_element(self.lineEdit_result_roi_left, [127, 696, 40, 22], "lineEdit_result_roi_left", text="10", font=font_ee)
        self.lineEdit_result_roi_right = QtWidgets.QLineEdit(self.groupBox_result)
        self.__create_element(self.lineEdit_result_roi_right, [217, 696, 40, 22], "lineEdit_result_roi_right", text="20", font=font_ee)
        self.lineEdit_result_roi_top = QtWidgets.QLineEdit(self.groupBox_result)
        self.__create_element(self.lineEdit_result_roi_top, [297, 696, 40, 22], "lineEdit_result_roi_top", text="10", font=font_ee)
        self.lineEdit_result_roi_bottom = QtWidgets.QLineEdit(self.groupBox_result)
        self.__create_element(self.lineEdit_result_roi_bottom, [407, 696, 40, 22], "lineEdit_result_roi_bottom", text="20", font=font_ee)
        self.pushButton_result_turn_roi = QtWidgets.QPushButton(self.groupBox_result)
        self.__create_element(self.pushButton_result_turn_roi, [535, 696, 80, 22], "pushButton_result_turn_roi", text="Turn ROI", font=font_headline)
        self.pushButton_result_export_integrated_roi = QtWidgets.QPushButton(self.groupBox_result)
        self.__create_element(self.pushButton_result_export_integrated_roi, [620, 696, 151, 22], "pushButton_result_export_integrated_roi", text="Export int. ROI", font=font_headline)

        # This part of Result block is visible
        self.checkBox_result_devide_by_monitor = QtWidgets.QCheckBox(self.groupBox_result)
        self.__create_element(self.checkBox_result_devide_by_monitor, [5, 8, 241, 22], "checkBox_result_devide_by_monitor", text="Devide by monitors", font=font_ee)
        self.label_result_aspect_ratio = QtWidgets.QLabel(self.groupBox_result)
        self.__create_element(self.label_result_aspect_ratio, [170, 8, 75, 20], "label_result_aspect_ratio", text="Aspect ratio:", font=font_ee)
        self.horizontalSlider_result_aspect_ratio = QtWidgets.QSlider(self.groupBox_result)
        self.__create_element(self.horizontalSlider_result_aspect_ratio, [250, 8, 140, 22], "horizontalSlider_result_aspect_ratio")
        ...
        self.__create_element(self.lineEdit_result_operation_sign, [450, 8, 20, 22], "lineEdit_result_operation_sign", text=" - ", font=font_ee)
        self.lineEdit_result_operation = QtWidgets.QLineEdit(self.groupBox_result)
        self.__create_element(self.lineEdit_result_operation, [475, 8, 200, 22], "lineEdit_result_operation", stylesheet="color:rgb(0,0,0)", enabled=False, font=font_ee)
        self.pushButton_result_swap_ab = QtWidgets.QPushButton(self.groupBox_result)
        self.__create_element(self.pushButton_result_swap_ab, [680, 8, 90, 22], "pushButton_result_swap_ab", text="(A<->B)", font=font_headline)
        self.graphicsView_result = pg.ImageView(self.groupBox_result)
        self.__create_element(self.graphicsView_result, [3, 34, 770, 684], "graphicsView_result")
        ...
        self.__create_element(self.label_result_reduce_number_of_pixels, [10, 722, 250, 20], "label_result_reduce_number_of_pixels", text="Reduce number of pixels in each direction by:", font=font_ee)
        self.checkBox_result_reduce_number_of_pixels_by_2 = QtWidgets.QCheckBox(self.groupBox_result)
        self.__create_element(self.checkBox_result_reduce_number_of_pixels_by_2, [270, 722, 241, 20], "checkBox_result_reduce_number_of_pixels_by_2", text="x2", font=font_ee)
        self.checkBox_result_reduce_number_of_pixels_by_4 = QtWidgets.QCheckBox(self.groupBox_result)
        self.__create_element(self.checkBox_result_reduce_number_of_pixels_by_4, [315, 722, 241, 20], "checkBox_result_reduce_number_of_pixels_by_4", text="x4", font=font_ee)
        self.checkBox_result_reduce_number_of_pixels_by_8 = QtWidgets.QCheckBox(self.groupBox_result)
        self.__create_element(self.checkBox_result_reduce_number_of_pixels_by_8, [360, 722, 241, 20], "checkBox_result_reduce_number_of_pixels_by_8", text="x8", font=font_ee)
        self.pushButton_result_export = QtWidgets.QPushButton(self.groupBox_result)
        self.__create_element(self.pushButton_result_export, [620, 721, 151, 22], "pushButton_result_export", text="Export result (2D)", font=font_headline)
        self.pushButton_result_ROI = QtWidgets.QPushButton(self.groupBox_result)
        self.__create_element(self.pushButton_result_ROI, [535, 721, 80, 22], "pushButton_result_ROI", text="ROI", font=font_headline)
...
class GUI(Ui_MainWindow):
    ...
    current_dir = ""
    current_dir = os.getcwd().replace("\\", "/") + "/"  # Mac  for i in sys.argv[0].split("/")[:-4]: current_dir += i + "/"
    ...
    def draw_res(self):
            ...
            with h5py.File(self.lineEdit_scan_A_name.text(), 'r') as FILE:
                ...
                for index, scaler in enumerate(FILE[list(FILE.keys())[0]].get("instrument").get('scalers').get('SPEC_counter_mnemonics')):
                    ...
                    if monitor_A_identifier in str(scaler):
                        ...
                        else: monitor_A = numpy.array(FILE[list(FILE.keys())[0]].get("instrument").get('scalers').get('data')).T[index][int(self.comboBox_scan_A_point_number.currentText())]
            ...
            with h5py.File(self.lineEdit_scan_B_name.text(), 'r') as FILE:
                ...
                for index, scaler in enumerate(FILE[list(FILE.keys())[0]].get("instrument").get('scalers').get('SPEC_counter_mnemonics')):
                    ...
                    if monitor_B_identifier in str(scaler):
                        ...
                        else: monitor_B = numpy.array(FILE[list(FILE.keys())[0]].get("instrument").get('scalers').get('data')).T[index][int(self.comboBox_scan_B_point_number.currentText())]
        ...
        if self.line_A[0] == "" and not self.line_B[0] == "": RES = self.detector_image_B
            ...
            if self.checkBox_result_devide_by_monitor.isChecked(): main = numpy.divide(main, main_mon/min_mon)

        scale_low, scale_high = 0, 1

        if self.lineEdit_result_operation.text().find("+") > 0: RES = numpy.add(main, min)
        elif self.lineEdit_result_operation.text().find("-") > 0:
            RES, scale_low, scale_high = numpy.subtract(main, min), -10, 10
            if self.checkBox_result_reduce_number_of_pixels_by_2.isChecked() or self.checkBox_result_reduce_number_of_pixels_by_4.isChecked() or self.checkBox_result_reduce_number_of_pixels_by_8.isChecked(): scale_low, scale_high = -20, 20
