...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def change_interface(self):
        ...
        if  not self.last_type_A == self.comboBox_type_A.currentText():
            ...
            if self.comboBox_type_A.currentText() == "Single point": self.comboBox_point_number_A.setCurrentIndex(0)
            # if we have "2D map" as a mode and we just changet to it -> change Scan B Type to "2D map" also
            elif self.comboBox_type_A.currentText() == "2D map": self.comboBox_type_B.setCurrentIndex(2)
            # if we changed from "2D map" -> change B also
            if self.last_type_A == "2D map":
                if self.comboBox_type_A.currentText() == "Single point": self.comboBox_type_B.setCurrentIndex(0)
                elif self.comboBox_type_A.currentText() == "Integrated image": self.comboBox_type_B.setCurrentIndex(1)

        # same for B
        if not self.last_type_B == self.comboBox_type_B.currentText():
            if self.comboBox_type_B.currentText() == "Single point": self.comboBox_point_number_B.setCurrentIndex(0)
            elif self.comboBox_type_B.currentText() == "2D map": self.comboBox_type_A.setCurrentIndex(2)
            if self.last_type_B == "2D map":
                if self.comboBox_type_B.currentText() == "Single point": self.comboBox_type_A.setCurrentIndex(0)
                elif self.comboBox_type_B.currentText() == "Integrated image": self.comboBox_type_A.setCurrentIndex(1)
    ...
    def diff_line(self):
        ...
        if self.comboBox_type_A.currentText() == "Single point" and not self.comboBox_point_number_A.currentText() == "":
            self.line_A[0] = "A(" + str(self.comboBox_polarisation_A.currentText()) + ")(" + str(self.comboBox_point_number_A.currentText()) + ")"
        ...
        if self.comboBox_type_B.currentText() == "Single point" and not self.comboBox_point_number_B.currentText() == "":
            self.line_B[0] = "B(" + str(self.comboBox_polarisation_B.currentText()) + ")(" + str(self.comboBox_point_number_B.currentText()) + ")"
        ...
        # otherwice check if a line is already presented and what is the first. Keep the same order
            ...
            else: line = self.line_B[0] + self.lineEdit_operation_sign.text() + self.line_A[0]
    ...
    def button_swap_ab(self):
        ...
        else: line = self.line_A[0] + self.lineEdit_operation_sign.text() + self.line_B[0]
    ...
    def draw_res(self):
        ...
        if (self.comboBox_type_A.currentText() == "2D map" and not self.comboBox_type_B.currentText() == "2D map") or (self.comboBox_type_B.currentText() == "2D map" and not self.comboBox_type_A.currentText() == "2D map"): return
