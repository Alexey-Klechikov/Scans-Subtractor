...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.graphicsView_result_integrated_roi.getAxis("top").tickFont = font_graphs_2
        ...
        self.graphicsView_result_integrated_roi.showAxis("right")
        #self.graphicsView_result_integrated_roi.getAxis("right").tickFont = font_graphs_2
        ...
        self.checkBox_result_devide_by_monitor.setGeometry(QtCore.QRect(5, 22, 241, 22))
        self.checkBox_result_devide_by_monitor.setObjectName("checkBox_result_devide_by_monitor")
        self.checkBox_result_devide_by_monitor.setText("Devide by monitors")
        self.checkBox_result_devide_by_monitor.setFont(font_ee)
